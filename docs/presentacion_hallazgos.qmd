...
![Mapa 2026: dos nubes (izquierda / derecha); el bloque de Kast está a la derecha](../outputs/imagenes/bcall_mapa_2026.png){width="88%"}
...
![El núcleo rojo (Republicanos) es un punto denso; UDI, RN y libertarios se estiran hacia arriba](../outputs/imagenes/bcall_bloque_2026.png){width="88%"}
...
![Quién se sale más de su propio patrón de voto](../outputs/imagenes/bcall_volatiles_2026.png){width="82%"}
...
![Centro = con quién vota; ancho = cuánto se sale](../outputs/imagenes/bcall_densidades_2026.png){width="88%"}
...
![Nombre del repertorio, no código A1/C1](../outputs/imagenes/canon_pdl_repertorios.png){width="88%"}
...
![Qué tan juntos votan en el bloque de Kast](../outputs/imagenes/canon_camara_rice.png){width="78%"}

## ¿Republicanos y libertarios votan distinto?

**En el 91,8 % de las votaciones eligieron el mismo lado** (4 702 votaciones).

![Mismo lado: Republicanos y libertarios](../outputs/imagenes/canon_camara_rep_pnl.png){width="72%"}
...
![Qué tan juntos votan Republicanos cada mes](../outputs/imagenes/canon_camara_rice_rep_mes.png){width="88%"}
...
![Nombre del repertorio en discursos de Kast](../outputs/imagenes/discursos_kast_repertorios.png){width="88%"}
