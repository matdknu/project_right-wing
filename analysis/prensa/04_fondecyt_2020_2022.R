...
#
# Uso:
#   FONDECYT_REBUILD=1 Rscript analysis/prensa/03_fondecyt_build.R
#   Rscript analysis/prensa/04_fondecyt_2020_2022.R
...
if (!file.exists(path_parquet)) {
  ...
  status <- system2("Rscript", args = "analysis/prensa/03_fondecyt_build.R", stdout = TRUE, stderr = TRUE)
  cat(paste(status, collapse = "\n"), "\n")
}

if (!file.exists(path_parquet)) {
  stop("Corre primero: FONDECYT_REBUILD=1 Rscript analysis/prensa/03_fondecyt_build.R")
}
